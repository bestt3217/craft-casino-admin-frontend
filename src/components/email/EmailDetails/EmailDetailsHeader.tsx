...
export default function EmailDetailsHeader() {
  ...
  return (
    <div className='flex flex-col justify-between border-b border-gray-200 sm:flex-row dark:border-gray-800'>
      <div className='flex w-full items-center justify-between gap-3 px-4 py-4 sm:justify-normal'>
        <button
          onClick={goBack}
        ...
        <div className='flex items-center gap-3'>
          <div className='flex'>
            <button className='hover:text-error-500 dark:hover:text-error-500 flex h-10 w-10 items-center justify-center text-gray-500 ring-1 ring-gray-200 transition ring-inset first:rounded-l-lg last:rounded-r-lg hover:bg-gray-100 dark:bg-white/[0.03] dark:text-gray-400 dark:ring-gray-700 dark:hover:bg-white/[0.05]'>
              <svg
                width='20'
                height='20'
                viewBox='0 0 20 20'
            ...
            <button className='-ml-px flex h-10 w-10 items-center justify-center text-gray-500 ring-1 ring-gray-200 transition ring-inset first:rounded-l-lg last:rounded-r-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-white/[0.03] dark:text-gray-400 dark:ring-gray-700 dark:hover:bg-white/[0.05] dark:hover:text-white'>
              <svg
                width='20'
                height='20'
                viewBox='0 0 20 20'
            ...
            <button className='-ml-px flex h-10 w-10 items-center justify-center rounded-r-lg text-gray-500 ring-1 ring-gray-200 transition ring-inset first:rounded-l-lg last:rounded-r-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-white/[0.03] dark:text-gray-400 dark:ring-gray-700 dark:hover:bg-white/[0.05] dark:hover:text-white'>
              <svg
                width='20'
                height='20'
                viewBox='0 0 20 20'
          ...
          <button className='flex h-10 w-10 items-center justify-center rounded-lg border border-gray-200 bg-white text-gray-500 transition hover:bg-gray-50 hover:text-gray-700 dark:border-gray-800 dark:bg-white/[0.03] dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200'>
            <svg
      ...
      <div className='flex w-full items-center justify-between gap-4 border-t border-gray-200 px-4 py-3 sm:justify-end sm:border-t-0 sm:py-5 dark:border-gray-800'>
        ...
        <div className='flex items-center justify-end gap-2'>
          <button className='flex h-8 w-8 items-center justify-center rounded-lg border border-gray-200 bg-white text-gray-500 transition hover:bg-gray-50 dark:border-gray-800 dark:bg-white/[0.03] dark:text-gray-400 dark:hover:bg-white/[0.07] dark:hover:text-gray-200'>
            <svg
              width='20'
              height='20'
              viewBox='0 0 20 20'
