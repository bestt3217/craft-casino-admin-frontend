      ...
      <div className='flex w-full items-center gap-2'>
        <div className='relative w-full sm:w-auto'>
          ...
          <Dropdown
            ...
            className='shadow-theme-lg dark:bg-gray-dark absolute top-full left-0 z-40 mt-1 w-40 space-y-1 rounded-2xl border border-gray-200 bg-white p-2 dark:border-gray-800'
          >
            <DropdownItem
        ...
        <div className='relative inline-block'>
          <button
            ...
            className='dropdown-toggle flex h-10 w-10 max-w-10 items-center justify-center rounded-lg border border-gray-200 text-gray-500 transition-colors hover:bg-gray-100 dark:border-white/[0.05] dark:text-gray-400 dark:hover:bg-gray-800'
          >
      ...
      <div className='relative w-full sm:max-w-[236px]'>
        <form>
          ...
          <input
            type='text'
            placeholder='Search...'
            className='dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-10 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 pl-[42px] text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:text-white/90 dark:placeholder:text-white/30'
          />
        </form>
      </div>
    </div>
