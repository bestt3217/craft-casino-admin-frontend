    ...
    <div className='sticky bottom-0 border-t border-gray-200 p-3 dark:border-gray-800'>
      <form className='flex items-center justify-between'>
        <div className='relative w-full'>
          <button className='absolute top-1/2 left-1 -translate-y-1/2 text-gray-500 hover:text-gray-800 sm:left-3 dark:text-gray-400 dark:hover:text-white/90'>
            <svg
          ...
          <input
            ...
            className='h-9 w-full border-none bg-transparent pr-5 pl-12 text-sm text-gray-800 outline-hidden placeholder:text-gray-400 focus:border-0 focus:ring-0 dark:text-white/90'
          />
        </div>
        ...
        <div className='flex items-center'>
          ...
          <button className='bg-brand-500 hover:bg-brand-600 ml-3 flex h-9 w-9 items-center justify-center rounded-lg text-white xl:ml-5'>
            <svg
              width='20'
              height='20'
              viewBox='0 0 20 20'
