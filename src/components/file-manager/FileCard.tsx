...
const FileCard: React.FC<FileCardProps> = ({
  ...
  return (
    <div className='flex items-center justify-between rounded-2xl border border-gray-100 bg-white py-4 pr-4 pl-4 xl:pr-5 dark:border-gray-800 dark:bg-white/[0.03]'>
