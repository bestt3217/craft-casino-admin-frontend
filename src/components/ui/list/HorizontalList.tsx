  ...
  return (
    <div className='rounded-lg border border-gray-200 bg-white sm:w-fit dark:border-gray-800 dark:bg-white/[0.03]'>
      <ul className='flex flex-col md:flex-row'>
        <li className='flex items-center gap-2 border-b border-gray-200 px-3 py-2.5 text-sm text-gray-500 last:border-0 md:border-r md:border-b-0 dark:border-gray-800 dark:text-gray-400'>
